...
Need help with the VitalsOS iOS app?

## Contact

- **GitHub Issues (preferred):** [github.com/Wateraf/VitalsOS-legal/issues](https://github.com/Wateraf/VitalsOS-legal/issues)  
  Bug reports, feature requests, and privacy questions welcome.

- **App Store:** Use the developer contact link on the VitalsOS product page if you prefer email.
